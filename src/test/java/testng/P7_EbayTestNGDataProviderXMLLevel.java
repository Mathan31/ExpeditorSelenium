...
//Modular Framework
public class P7_EbayTestNGDataProviderXMLLevel {
	...
	public String[][] productData() {
		...
		datas[1][0] = "iPhone";
		datas[1][1] = "Cell Phones & Accessories";
		
		datas[2][0] = "Bat";
		datas[2][1] = "Sporting Goods";
		return datas;
	}
	
	@Test(priority = 4,dataProvider = "SearchData")
	public  void productSearch(String prodName,String prodCat) {
