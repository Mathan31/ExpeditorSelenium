...
public class ActionsScroller {
	...
	public static void sliderHandle() {
		WebElement oSlider,oMover;
		driver.switchTo().frame(0);
		oSlider = driver.findElement(By.id("slider"));
		oMover = driver.findElement(By.xpath("//div[@id='slider']/span"));
		int width = oSlider.getRect().getWidth();
		Actions actions = new Actions(driver);
		actions.clickAndHold(oMover).moveByOffset(width/2, 0).perform();
	}
