...
public class EbayTakeScreenShot {
	...
	public static void productSearch(String prodName,String prodCatagory) throws Exception {
		WebElement oSearchText,oCatagorySelect,oSearcButton,oLogo;
		oLogo = driver.findElement(By.id("gh-logo"));
		ScreenShotSession.takeScreenShotAsFileByPassingWebElement(oLogo, "EbayLogo");
